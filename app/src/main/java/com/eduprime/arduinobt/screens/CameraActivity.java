...
import com.eduprime.arduinobt.screens.*;
...
public class CameraActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        // Request camera permission, then start preview
        ...
        // Capture button (optional action — expand later)
        Button captureBtn = findViewById(R.id.captureBtn);
        captureBtn.setOnClickListener(v -> {
            // TODO: add ImageCapture use-case here later
